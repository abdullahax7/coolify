...
const FSOC_FIELDS: FormField[] = [
  ...
  { key: 'waterPayer', label: 'Water Charges Paid By', type: 'text', placeholder: 'Landlord / Tenant' },
  { key: 'gasPayer', label: 'Gas Paid By', type: 'text' },
  { key: 'tvPayer', label: 'TV Licence Paid By', type: 'text' },
  { key: 'broadbandPayer', label: 'Broadband Paid By', type: 'text' },
  { key: 'councilTaxPayer', label: 'Council Tax Paid By', type: 'text' },
  { key: 'electricityPayer', label: 'Electricity Paid By', type: 'text' },
  { key: 'phonePayer', label: 'Telephone Paid By', type: 'text' },
  { key: 'otherPayer', label: 'Other Utilities Paid By', type: 'text' },
